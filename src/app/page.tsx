  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <h1 className="text-xl font-bold">Share encrypted data between devices via cycling QR codes</h1>
        <div className="grid w-full">
          <div className="my-2">
            ...
            {toggleShareDialog && <Button     onClick={() => {
                  setToggleShareDialog(false);
                }}>Go to generate Qr code</Button>}
          </div>
          {!toggleShareDialog && <Card>
            <CardHeader>
              <CardTitle>
                <span>Encrypt</span>
              </CardTitle>
            ...
            <CardContent>
              ...
              {!toggleShareDialog && encryptedData && (
                <ExportDialog
                  setToggleExportDialog={setToggleShareDialog}
